  ...
  return (
      ...
      <div className="m-14 text-center bg-white text-black sm:invisible overflow-scroll grid content-center place-items-center">
        ...
        <p className="text-lg font-light text-[#767676] mt-10">
          You must verify your account before accessing the Immer platform. We
          sent you a verification email to set up your account.
        </p>
        <p className="text-lg font-light text-[#767676] mt-52">
