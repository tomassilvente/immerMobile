...
export default function signUp(){ 
    return (
        <div className="m-14 text-center bg-white text-black sm:invisible overflow-scroll">
            ...
            <p className="text-lg font-light text-[#767676] mt-3">Don't miss the opportunity to be part of the entertainment revolution.</p>
            <Link className="grid grid-cols-6 content-center place-items-center text-lg mt-16 mx-8 border py-4 border-black rounded-full" href='/'>
            ...
            <Link className="grid grid-cols-6 content-center place-items-center text-lg mt-4 mx-8 border py-4 border-black rounded-full" href='/'>
                <div className="flex col-start-2 col-end-6">
            ...
            <Link className="grid grid-cols-6 content-center place-items-center text-lg mt-4 mx-8 border py-3 border-black rounded-full" href='/signup/create'>
                <div className="flex col-start-2 col-end-6">
            ...
            <p className="text-sm font-light text-[#767676] mt-10">By continuing, you agree to Immer Terms of Service and Privacy Policy.</p>
        </div>
)}