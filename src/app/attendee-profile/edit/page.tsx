            ...
            <div>
                    ...
                    <div className='w-full'>
                        ...
                        <span className='absolute cursor-pointer bottom-5 right-5 bg-[#FFF]/40 rounded p-[1px]'>
                            ...
                            <g clip-path="url(#clip0_5725_14562)">
                                <path d="M9.75 15.197C9.75 15.722 9.8475 16.2245 10.0125 16.697H3.75C2.925 16.697 2.25 16.0295 2.25 15.197V4.69702C2.25 3.87202 2.925 3.19702 3.75 3.19702H14.25C15.0825 3.19702 15.75 3.87202 15.75 4.69702V10.9595C15.2775 10.7945 14.775 10.697 14.25 10.697V4.69702H3.75V15.197H9.75ZM10.47 10.1645L8.4075 12.8195L6.9375 11.0495L4.875 13.697H10.0125C10.3125 12.857 10.8525 12.1295 11.55 11.6045L10.47 10.1645ZM15 14.447V12.197H13.5V14.447H11.25V15.947H13.5V18.197H15V15.947H17.25V14.447H15Z" fill="white"/>
                            </g>
                            <defs>
                                <clipPath id="clip0_5725_14562">
                                <rect width="18" height="18" fill="white" transform="translate(0 0.947021)"/>
                                </clipPath>
                            </defs>
                            </svg>
                        </span>
                ...
                <div className='px-[14px]'>
                    <form className='flex flex-col gap-3 my-4'>
                        ...
                        <input className='input-field' type="text" placeholder='Date of birth'/>
                        ...
                        <input className='input-field' type="text" placeholder='Interests'/>
                    </form>
                </div>
            </div>
        </div>
