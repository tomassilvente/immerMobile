                ...
                </div>
                {
                    activeDayIndex === 0
                      ? podcasts.map(podcast => (
                            <Episodes key={podcast.id} openShare={openShare} title={podcast.title} image={podcast.image} about={podcast.about} releaseDay={podcast.releaseDay} duration={podcast.duration} />
                      ))
                      : (
