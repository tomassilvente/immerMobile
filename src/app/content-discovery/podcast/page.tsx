...
import PodcastHeader from "../../../components/ContentDiscovery/PodcastHeader";
import Episodes from "../../../components/ContentDiscovery/Episodes";
import About from "../../../components/ContentDiscovery/About";
  ...
  const podcasts = [
    {
      ...
      duration: 45,
      about:
        "Lorem ipsum dolor sit amet consectetur. Neque dui sit venenatis pulvinar lacus diam. Tellus condimentum neque sapien velit pretium endrerit...",
    },
    {
      id: 2,
      title: "Brooks Davis Live",
  ...
  return (
    <MobileLayout>
      <Link href={"/content-discovery/podcast/onPlay"} />
        <PodcastHeader
          eventTitle="Brooks Davis"
          category="Comedy"
          listeners="11.2K"
          eventImg={"../assets/Vert3.png"}
        />
      <div className="m-3">
