...
export default function content({ payment = true }: any): JSX.Element {
  ...
  const toggleState = (key: "isFeedOpen" | "LikeButton" | "CommentOpen") => {
      ...
      <MobileLayout>
        {payment !== null && payment !== undefined ? (
          state.isFeedOpen ? (
            ...
            <>
              <Link
                className="hover:cursor-pointer absolute ml-[10px] mt-[10px] z-1"
                href={"/content-discovery"}
              >
                <SvgBackVectorWhite width={30} height={30} className="" />
              </Link>
        ...
        <div className="m-4">
          ...
          <div className="flex mt-8 text-center font-light">
            ...
            <div className="ml-10">
              <SvgCommentButton
                onClick={() => toggleState("CommentOpen")}
                width={40}
                height={40}
              />
              <p>93</p>
          ...
          {payment !== null && payment !== undefined ? (
            ...
            <SimpleButton
              text="Buy and watch"
              onClick={() => toggleState("isFeedOpen")}
            />
          )}
          {state.isFeedOpen ? (
            <div className=" bg-white absolute h-[100vh] w-[448px] top-6 z-10 items-center">
              ...
              <div className=" m-5 flex">
                <p className="font-semibold text-xl mt-3 text-gray-600">
                  Payment Details
                </p>
                <SvgDropDownVector
                  onClick={() => toggleState("isFeedOpen")}
                  className="ml-[55%] mt-6"
                />
              </div>
              <div className="m-5 p-3 border border-primary rounded-xl  bg-[#faf5f2]">
                <p className="text-xl font-semibold mt-2">
                  {DemoData.eventOrganizer}
                </p>
                ...
                <div className="flex">
                  ...
                  <Link className="text-primary ml-[65%] text-xl mt-2" href="/">
                    Detail
                  </Link>
                </div>
              </div>
              <div className="m-3 mt-[-80px]">
                ...
                <div className="bg-[#FFF0E5] mt-16 p-10 rounded-t-xl">
                  <div className="grid grid-cols-4 text-xl mb-4">
                    ...
                    <p className="col-start-4 ml-10">${DemoData.eventPrice}</p>
                  </div>
                  <hr />
