    ...
    return(
        <div className="bg-gray-100 py-5 px-3 grid grid-cols-6">
            ...
            {Follow
                        ...
                        : <button onClick={setFollowed} className="text-sm w-[120px] text-center mt-[25px] h-[45px] bg-primary text-white rounded-md col-start-4 ml-[40px]"> Follow  </button>
                    }
            <Link href='/ticket-purchase' className="col-start-6 mt-6 ml-8 hover:cursor-pointer"><SvgMessageButton width={44} height={46}/></Link>
        </div>
)}
