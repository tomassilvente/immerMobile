...
export default function TicketSelection(){
    ...
    return(
        <div className="bg-white text-black rounded-t-[50px] mt-14 p-5 overflow-scroll ">
            ...
            <div className="flex"> 
                <select onChange={e => ticketQuant(e.target.value)} className="border-primary shadow-sm flex border w-[60%] h-[30px] rounded-md" name="tickets" id="tickets">
                    <option className="ml-3 mt-1 text-xs font-semibold" value={1} selected>1 Ticket</option>
