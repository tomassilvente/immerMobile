...
export default function passwordChange(){ 
    ...
    return (
        <div className="m-14 text-center bg-white text-black sm:invisible overflow-scroll ">
            ...
            <p className="text-lg font-light text-[#767676] mt-10">Please enter the new password for your account</p>
            ...
            <p className="text-xl mt-5">New password</p>
                <input
                    ...
                    className="border rounded-md w-[100%] mt-3 mb-2 py-4 pl-3 focus:border-black after:border-[5px]" placeholder="Enter Your Password" id="password" name="password" type="password"/>
                {
                correct
                ...
                <input 
                    ...
                    className="border rounded-md w-[100%] mt-3 mb-2 py-4 pl-3 focus:border-black" placeholder="Enter Your Password" id="confirmPassword" name="confirmPassword" type="password"/>
                <br />
                <span
                    style={{
                        color:
