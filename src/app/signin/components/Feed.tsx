...
export default function Feed({buttonText, title, title2, isFeedOpen, setFeedClose, link}: any){
    return(
        <div
        ...
        style={{
                ...
                <div className="bg-white grid content-center place-items-center m-14 p-10 mx-20 rounded-[40px]">
                    ...
                    <p className="font-light mt-16">{title2}  
                    </p>
                    <button
                ...
                {
                    link
                    ? <Link className="text-primary font-semibold mt-12 mb-5" href='/signin'>Sign In</Link>
                    : ''
                }
                </div>
            </div>
