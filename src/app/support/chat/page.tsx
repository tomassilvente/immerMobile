                ...
                <div className="p-2 ">
                    <div className="p-2 rounded-full bg-white flex gap-2 border border-gray-500">
                        ...
                        <div className="h-8 w-8 rounded-full flex items-center justify-center cursor-pointer">
                            ...
                            <g clip-path="url(#clip0_9579_2452)">
                            <path d="M9.99935 18.464C14.6017 18.464 18.3327 14.7331 18.3327 10.1307C18.3327 5.52832 14.6017 1.79736 9.99935 1.79736C5.39698 1.79736 1.66602 5.52832 1.66602 10.1307C1.66602 14.7331 5.39698 18.464 9.99935 18.464Z" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M6.66602 11.7974C6.66602 11.7974 7.91602 13.464 9.99935 13.464C12.0827 13.464 13.3327 11.7974 13.3327 11.7974" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.5 7.63086H7.50833" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M12.5 7.63086H12.5083" stroke="#D9D9D9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
                        ...
                        <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_9579_2459)">
                            <path d="M25.9267 14.8918L9.9399 22.3904L12.9637 14.7603L10.0953 7.07053L25.9267 14.8918Z" fill="white"/>
                            <path d="M18.1793 14.8138L12.9631 14.7608" stroke="#FFD6B8" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
