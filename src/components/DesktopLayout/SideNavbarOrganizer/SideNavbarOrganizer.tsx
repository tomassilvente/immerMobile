...
import Venue from "../../../../public/assets/venue.svg";
import Dashboard from "../../../../public/assets/dashboard.svg";

export const SideNavbarOrganizer = ({
  className = "",
}: {
  className?: string;
}): JSX.Element => {
    ...
    >
      ...
      <ul className="flex flex-col items-start justify-start h-full">
        ...
        <li>
          <Link href={"/Dashboard"}>
            <div className="flex items-center mr-4">
              <Image width={80} height={80} src={Dashboard} alt="dashboard" />
        ...
        <li className="flex flex-col items-center">
          <Link href={"/Venue"}>
            <div className="flex items-center mr-4">
              <Image width={80} height={80} src={Venue} alt="venue" />
