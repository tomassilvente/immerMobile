  ...
  return (
    <div className="flex gap-3 bg-[#F8F8F8] rounded-lg shadow px-2 py-3">
      ...
      <div className="flex flex-col gap-3 text-xs text-[#666666]">
        ...
        <p className="flexed gap-1">
          <SvgCalendar /> Sat, 15 June, 2023
        </p>
        <p className="flexed gap-1">
          <SvgClockBlack /> 6:25pm - 10:00pm
        </p>
      </div>
